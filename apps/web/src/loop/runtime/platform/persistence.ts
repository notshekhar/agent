...
>()("@loop/runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@loop/runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@loop/runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@loop/runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
