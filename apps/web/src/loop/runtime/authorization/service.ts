import { EnvironmentId, type ExecutionEnvironmentDescriptor } from "@loop/contracts";
import type { RelayManagedEndpoint } from "@loop/contracts/relay";
import {
...
>()("@loop/runtime/authorization/service/RemoteEnvironmentAuthorization") {}
