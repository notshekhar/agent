...
import { RelayManagedEndpoint } from "@loop/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@loop/runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@loop/runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
