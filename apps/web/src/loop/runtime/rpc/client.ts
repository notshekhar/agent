import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@loop/contracts";
...
}>("@loop/runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@loop/runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
