import { type ServerLifecycleWelcomePayload } from "@loop/contracts";
import { scopedProjectKey, scopeProjectRef } from "@loop/runtime/environment";
import { squashAtomCommandFailure } from "@loop/runtime/state/runtime";
import {
  Outlet,
  createRootRoute,
