...
import { effectiveSettled, effectiveSnoozed } from "@loop/runtime/state/thread-settled";
import {
  parseScopedThreadKey,
  scopedThreadKey,
  scopeProjectRef,
  scopeThreadRef,
} from "@loop/runtime/environment";
import {
  applyClaudePromptEffortPrefix,
  createModelSelection,
  resolvePromptInjectedEffort,
} from "@loop/shared/model";
import { CHAT_LIST_ANCHOR_OFFSET } from "@loop/shared/chatList";
import { projectScriptCwd, projectScriptRuntimeEnv } from "@loop/shared/projectScripts";
import { truncate } from "@loop/shared/String";
import { nextTerminalId, resolveTerminalSessionLabel } from "@loop/shared/terminalLabels";
