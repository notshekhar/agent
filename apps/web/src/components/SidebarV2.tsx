...
import {
  ...
  effectiveSnoozed,
  threadWokeAt,
} from "@loop/runtime/state/thread-settled";
...
import type { ScopedThreadRef, SidebarProjectGroupingMode } from "@loop/contracts";
import {
  AlarmClockIcon,
  AlarmClockOffIcon,
  CheckIcon,
...
export default function SidebarV2() {
  ...
  const { settleThread, unsettleThread, snoozeThread, unsnoozeThread, deleteThread, archiveThread } =
    useThreadActions();
      ...
      void (async () => {
        ...
        switch (clicked.value) {
          ...
          case "mark-unread":
            ...
            return;
          case "archive": {
            // No confirmation: nothing is destroyed and Settings → Archive
            // puts it straight back, so a prompt would only be in the way.
