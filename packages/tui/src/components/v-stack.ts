import { allocateStackSizes, Stack, type StackChild, type StackOptions, visibleStackEntries } from "./stack";
...
export type { StackChild, StackEntry, StackEntryOptions, StackOptions } from "./stack";
