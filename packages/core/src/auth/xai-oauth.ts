...
const CLIENT_ID = brandEnv("XAI_OAUTH_CLIENT_ID") || "b1a00492-073a-47ea-816f-4c329264a828";
const SCOPE = brandEnv("XAI_OAUTH_SCOPE") || "openid profile email offline_access grok-cli:access api:access";
const CALLBACK_HOST = brandEnv("XAI_OAUTH_CALLBACK_HOST") || "127.0.0.1";
const CALLBACK_PORT = Number.parseInt(brandEnv("XAI_OAUTH_CALLBACK_PORT") || "56121", 10);
...
export function getBaseUrl(): string {
    return (brandEnv("XAI_BASE_URL") || process.env.XAI_BASE_URL || DEFAULT_BASE_URL).replace(/\/+$/, "");
}
